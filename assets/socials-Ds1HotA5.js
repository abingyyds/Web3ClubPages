import{du as L,dx as T,e0 as d,dy as _,dz as I,dP as P,dk as h,dH as w,dj as U,dA as c,el as F,de as b,em as D,dN as N,en as k,dQ as x,dc as l,dI as S,eo as j,dd as u,ep as R,df as C,eq as z,ej as A,d$ as $}from"./index-DahFPixs.js";const M=L`
  :host {
...
`;var W=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let E=class extends I{constructor(){super(),this.unsubscribe=[],this.checked=k.state.isLegalCheckboxChecked,this.unsubscribe.push(k.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var O;const{termsConditionsUrl:e,privacyPolicyUrl:o}=h.state,r=(O=h.state.features)==null?void 0:O.legalCheckbox,s=!!(e||o)&&!!r&&!this.checked,a=s?-1:void 0;return c`
