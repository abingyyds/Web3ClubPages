import{ej as g,eE as j,dH as l,dI as pe,du as I,dv as X,dy as y,dz as k,dA as d,dx as c,dQ as S,dN as U,e0 as h,dw as me,dC as F,dc as w,d_ as Y,ez as fe,eo as G,dd as q,dk as R,dP as Z,dF as we,df as O,eF as V,ew as ae,d$ as be,dE as ce,eG as ge,er as ye,de as ve,dJ as xe}from"./index-CQ7lDuzc.js";import"./index-C_QVWVcG.js";import{S as ke}from"./SwapController-HXdpGLi7.js";const de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await j.isSIWXCloseDisabled()){g.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),g.close()}},$e=I`
  :host {
    display: block;
