import{da as k,db as v,dc as N,dd as y,de as $,df as C,dg as d,dx as c,dr as h,dS as m,dk as R,dT as f,dI as A,dv as S,dw as I,dq as T,dz as O,dU as b}from"./index-DDpJI8v-.js";const _=k`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var g=function(e,t,o,i){var s=arguments.length,r=s<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(r=(s<3?n(r):s>3?n(t,o,r):n(t,o))||r);return s>3&&r&&Object.defineProperty(t,o,r),r};let p=class extends C{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return d`
    ...
    </wui-flex>`}};p.styles=[v,N,_];g([y({type:Array})],p.prototype,"networkImages",void 0);g([y()],p.prototype,"text",void 0);p=g([$("wui-compatible-network")],p);const q=k`
