import{eh as g,eC as j,dF as l,dG as pe,ds as I,dt as X,dw as y,dx as k,dy as d,dv as c,dO as S,dL as U,d_ as h,du as me,dA as F,dc as w,dY as Y,ex as fe,em as G,dd as q,dk as R,dN as Z,dD as we,df as P,eD as V,eu as ae,dZ as be,dC as ce,eE as ge,ep as ye,de as ve,dH as xe}from"./index-Dq37iMi7.js";import"./index-Bwf7SnUh.js";import{S as ke}from"./SwapController-GnRilVwa.js";const de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await j.isSIWXCloseDisabled()){g.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),g.close()}},$e=I`
  :host {
    display: block;
