import{du as A,e0 as l,dx as w,dy as D,dz as C,dc as $,dl as h,dA as u,dj as V,dd as N,dH as S,de as K,ej as M,dK as F,dL as Q,dv as W,dw as H,eA as _}from"./index-BCoRrsI0.js";import{S as s}from"./SwapController-HMryF1jU.js";import"./index-BXPi51h9.js";const q={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",U=a==="x",E=n===",",R=n===".",B=n>="0"&&n<="9";!r&&(c||b||I||U)&&e.preventDefault(),t==="0"&&!E&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(E||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!E&&e.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
