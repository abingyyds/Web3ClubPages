import{e3 as x,ep as ae,dq as c,ds as de,da as C,db as L,de as w,df as y,dg as d,dd as l,dI as W,dB as _,dU as u,dc as ue,di as D,dx as g,dS as j,ek as he,e9 as V,du as U,e0 as R,dF as F,dl as pe,dr as O,e5 as z,eh as ee,dT as me,dk as ne,eq as fe,er as we}from"./index-DDpJI8v-.js";import"./index-C7dnxFea.js";import{S as be}from"./SwapController-zkJ7kege.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
